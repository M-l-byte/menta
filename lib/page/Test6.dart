...
class _TestState extends State<Test6> {
  ...
  List<Question> questions = [
    Question("Question 1: Feeling nervous, anxious, or on edge ", 0),
    Question("Question 2: Not being able to stop or control worrying.", 0),
    Question("Question 3: Worrying too much about different things", 0),
    Question("Question 4: Trouble relaxing", 0),
    Question("Question 5: Being so restless that it is hard to sit still", 0),
    Question("Question 6: Becoming easily annoyed or irritable", 0),
    Question("Question 7:Feeling afraid as if something awful might happen", 0),
  ];
